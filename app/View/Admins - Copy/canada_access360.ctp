        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu menu-open">
                                <li class='active reeview'><a href="#"><i class="fa fa-user"></i>Students<span class="pull-right-container">
                                            <span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        ...
                                        <li class="active_sub_sub"><a href='canada_access360.html'>All access 360<small class="label pull-right bg1-red"><?php if($canada_student_acess360 > 0) { echo $canada_student_acess360; } ?></small></a></li>
                                    </ul>
                                </li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 class="title_">Canada Student All Access 360</h3>
