        ...
        <div class="wrapper">
                            ...
                            <ul class="treeview-menu menu-open">
                                <li class='active treeview'><a href="#"><i class="fa fa-user"></i>Students<span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        ...
                                        <li class="active_sub_sub"><a href='canada_career_advanced.html'>Career Advanced<small class="label pull-right bg1-red"><?php if($canada_student_advance > 0) { echo $canada_student_advance; } ?></small></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 class="title_">Canada Student Career Advance</h3>
