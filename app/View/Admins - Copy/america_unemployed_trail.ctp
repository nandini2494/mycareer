        ...
        <div class="wrapper">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu menu-open">
                                ...
                                <li class="active treeview"><a href="#"><i class="fa fa-male" aria-hidden="true"></i>Unemployed <span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        <li class="active_sub_sub"><a href="america_unemployed_trail.html">14Days trial<small class="label pull-right bg1-red"><?php if($america_unemployed_trail > 0) { echo $america_unemployed_trail; } ?></small></a></li>                                       
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 class="title_">America Unemployed Trial</h3>
