                            ...
                            <ul class="treeview-menu menu-open">
                                <li class='active treeview'><a href=""><i class="fa fa-user"></i>Students<span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        ...
                                        <li class="active_sub_sub"><a href='america_student_career_starter.html'>Career Starter<small class="label pull-right bg1-red"><?php if($america_student_starter > 0) { echo $america_student_starter; } ?></small></a></li>
