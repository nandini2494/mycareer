        ...
        <div class="wrapper">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu menu-open">
                                <li class='active treeview'><a href=""><i class="fa fa-user"></i>Students<span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        <li class="active_sub_sub"><a href="america_student_trail.html">14Days trial<small class="label pull-right bg1-red"><?php if($america_student_trail > 0) { echo $america_student_trail; } ?></small></a></li>                                      
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 class="title_">America Student Trial</h3>
