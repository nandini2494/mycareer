        ...
        <div class="wrapper">
                            ...
                            <ul class="treeview-menu menu-open">
                                ...
                                <li class='active treeview'><a href="#"><i class="fa fa-male" aria-hidden="true"></i>Unemployed <span class="pull-right-container">
                                    ...
                                    <ul class="treeview-menu menu-open">
                                        ...
                                        <li class="active_sub_sub"><a href='america_unemployed_career_starter.html'>Career Starter<small class="label pull-right bg1-red"><?php if($america_unemployed_starter > 0) { echo $america_unemployed_starter; } ?></small></a></li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <h3 class="title_">America Unemployed Career Starter</h3>
