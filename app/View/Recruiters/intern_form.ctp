    ...
    <div class="main-panel">
        ...
        <div class="new_view" style="margin:2% 3% 2% 3%;">	
            ...
            <form id="regForm" method="post" enctype="multipart/form-data">
                <input type="hidden" name="form_type" value="internPost">
                ...
                <div class="">
                    ...
                    <div class="col-sm-12 col-xs-12 new_margin">
                        <p><label>Length Of Internship *</label></p>
                        <p>
                    ...
                    <div class="col-sm-6 col-xs-12 rdi new_margin old_margin">
                        <p style="margin-bottom: 10px;">Is this a Paid Internship *</p>
                    ...
                    <div class="col-sm-6 col-xs-12 rdi new_margin old_margin">
                        <p style="margin-bottom: 10px;">Is your company an authorized Internship company *</p>
