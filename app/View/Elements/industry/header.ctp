...
<header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
        ...
        <a href="new_reference.html" class="logo">
            <span class="logo-lg">
                <img src="<?php echo DOMAIN_NAME ?>img/co-logo.png" class="img-responsive images_use_res" /></span>
        </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="<?php echo Router::url(['controller'=>'industrys/logout']) ?>" class="btn btn-default btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="dropdown-menu">    
                        ...
                        <li class="user-footer">                           
                            ...
                            <div class="pull-right">
                                <a href="<?php echo Router::url(['controller'=>'industrys/logout']) ?>" class="btn btn-success btn-flat">Sign out</a>
                            </div>
                        </li>
                    </ul>
                </li>
