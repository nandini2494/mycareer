        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php echo (($this->params['controller'] == 'admins') && (($this->action == 'canada_student_trail') || ($this->action == 'canada_career_starter') || ($this->action == 'canada_career_advanced') || ($this->action == 'canada_access360') || ($this->action == 'canada_unemployed_trail') || ($this->action == 'canada_unemployed_career_starter') || ($this->action == 'canada_unemployed_career_advanced') || ($this->action == 'canada_unemployed_career_access360') || ($this->action == 'canada_careeradvance_trail') || ($this->action == 'canada_alumni_career_starter') || ($this->action == 'canada_alumni_career_advance') || ($this->action == 'canada_alumni_acess360'))) ? 'active' : '' ?>">
                ...
                <ul class="treeview-menu menu-open">
                    ...
                    <li class='treeview <?php echo (($this->params['controller'] == 'admins') && (($this->action == 'canada_careeradvance_trail') || ($this->action == 'canada_alumni_career_starter') || ($this->action == 'canada_alumni_career_advance') || ($this->action == 'canada_alumni_acess360'))) ? 'active' : '' ?>'><a href="#"><i class="fa fa-star" aria-hidden="true"></i>Alumni
                            <span class="pull-right-container">
                                <span class="pull-right-container">
                        ...
                        <ul class="treeview-menu menu-open">                            
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'canada_alumni_career_starter')) ? 'active_sub_sub' : '' ?>"><a href='canada_alumni_career_starter.html'>Career Starter<small class="label pull-right bg1-red"><?php if($canada_advance_starter > 0) { echo $canada_advance_starter; } ?></small></a></li>
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'canada_alumni_career_advance')) ? 'active_sub_sub' : '' ?>"><a href='canada_alumni_career_advance.html'>Career Advanced<small class="label pull-right bg1-red"><?php if($canada_advance_advance > 0) { echo $canada_advance_advance; } ?></small></a></li>
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'canada_alumni_acess360')) ? 'active_sub_sub' : '' ?>"><a href='canada_alumni_acess360.html'>All access 360<small class="label pull-right bg1-red"><?php if($canada_advance_acess360 > 0) { echo $canada_advance_acess360; } ?></small></a></li>
                        </ul>
                    </li>
                </ul>
            </li>

            <li class="treeview <?php echo (($this->params['controller'] == 'admins') && (($this->action == 'america_student_trail') || ($this->action == 'america_student_career_starter') || ($this->action == 'america_student_career_advanced') || ($this->action == 'america_student_access360') || ($this->action == 'america_unemployed_trail') || ($this->action == 'america_unemployed_career_starter') || ($this->action == 'america_unemployed_career_advance') || ($this->action == 'america_unemployed_access360') || ($this->action == 'america_career_advance_trail') || ($this->action == 'america_alumni_career_starter') || ($this->action == 'america_alumni_career_advance') || ($this->action == 'america_alumni_access360'))) ? 'active' : '' ?>">
                ...
                <ul class="treeview-menu menu-open">
                    ...
                    <li class='treeview <?php echo (($this->params['controller'] == 'admins') && (($this->action == 'america_career_advance_trail') || ($this->action == 'america_alumni_career_starter') || ($this->action == 'america_alumni_career_advance') || ($this->action == 'america_alumni_access360'))) ? 'active' : '' ?>'><a href="#"><i class="fa fa-star" aria-hidden="true"></i>Alumni
                            <span class="pull-right-container">
                                <span class="pull-right-container">
                        ...
                        <ul class="treeview-menu menu-open">                           
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'america_alumni_career_starter')) ? 'active_sub_sub' : '' ?>"><a href='america_alumni_career_starter.html'>Career Starter<small class="label pull-right bg1-red"><?php if($america_advance_starter > 0) { echo $america_advance_starter; } ?></small></a></li>
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'america_alumni_career_advance')) ? 'active_sub_sub' : '' ?>"><a href='america_alumni_career_advance.html'>Career Advanced<small class="label pull-right bg1-red"><?php if($america_advance_advance > 0) { echo $america_advance_advance; } ?></small></a></li>
                            <li class="<?php echo (($this->params['controller'] == 'admins') && ($this->action == 'america_alumni_access360')) ? 'active_sub_sub' : '' ?>"><a href='america_alumni_access360.html'>All access 360<small class="label pull-right bg1-red"><?php if($america_advance_acess360 > 0) { echo $america_advance_acess360; } ?></small></a></li>
                        </ul>
                    </li>
                </ul>
            </li>
