                ...
                <div class='div_padding_use'>
                    ...
                    <div id="navbar" class="collapse navbar-collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right nav_use_custom">
                            ...
                            <li class="log_out">
                                <a href="<?php echo Router::url(['controller'=>'dashboards/logout_data']) ?>">
        ...
        <div class="wrapper">
                ...
                <div class="new_view" style="margin:2% 3% 2% 3%;">	
                    <div class="col-lg-12 col-md-12  ">
                        ...
                        <ul class="nav nav-tabs new_proper">   
                            ...
                            <?php } if(count($work_exp_mcd) > 0) { ?>
                            <li><a data-toggle="tab" href="#work_exp">Work Experiences</a></li>  
                            <?php } ?>
                        ...
                        <div class="tab-content tabs_use">
                            ...
                            <?php
                                    foreach ($work_exp_mcd as $w_place) {
                                ...
                                <div class="repeat_border_div">
                                    <div>
                                        <h3 style="background: #c02430;color: #fff;margin: 2% 0%;padding-left: 2em;border: solid 2px #c02430;text-transform: uppercase;">Workplace Experiences 
                                            <?php if($w_place['workplace_experience']['view_data'] == 'View/Print') { ?>
                                            <button style="margin-right: 2em;" class="essen_skill_div_delete1 pull-right" onclick='print_data("<?php echo $w_place['workplace_experience']['id'] ?>", "workplace_experience")'>Print</button>
                                            <?php } ?>
                                        </h3>
                                    </div>
                                    <div class="arund">
                ...
                <form method="post" id="message_data">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="user_id" value="<?php echo htmlspecialchars($this->params['url']['mcd_data']) ?>">
                                <div class='form-group'>
            ...
            <script>
                $("#like_button").click(function () {
                    ...
                    var user_mcd = <?php echo $user_mcd ?>;
                    $.ajax({
