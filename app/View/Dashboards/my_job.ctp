                            ...
                            <div class="table">
                                <table class="table table-user-information new_progress_use new_table table-responsive">
                                    ...
                                    foreach ($result as $data) { ?>
                                        ...
                                        <tr>
                                            <td><a href="job_detail.html?id=<?php echo $data['job_post']['id'] ?>"><?php echo $data['job_post']['company_name'] ?></a></td>
                                            <td><?php echo $data['job_post']['job_title'] ?></td>
                                            <td><?php echo $data['job_post']['province'] ?></td>
                                            <td><?php echo $data['job_post']['city'] ?></td>
                                            <td><?php echo $data['job_post']['form_type'] ?> </td>
                                            <td><button class="worked_data_used" onclick="job_apply(<?php echo $data['job_post']['id'] ?>)">Apply</button></td>
                                        </tr>
