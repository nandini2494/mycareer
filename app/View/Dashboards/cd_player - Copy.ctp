                    ...
                    <div id="resume_summary" class="tab-pane fade"> 
                        ...
                        <div class='tab-content tabs_use'>
                            ...
                            <div id="view_summary" class="tab-pane fade">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pull_layout_setup">         
                                    <div class='first_div'>
                                        <table width="70%" cellpadding="25" class="new_use_padding new_use_data1 table-striped data_profile">
                                            ...
                                            <?php if($view_summary['register']['country'] == 'Canada') { ?>
                                            <tr>
                                                <th>Province</th>
                                                <td><?php echo $view_summary['register']['provence'] ?></td>
                                            </tr>
                                            <?php } ?>

                                            <?php if($view_summary['register']['country'] == 'United States') { ?>
                                            <tr>
                                                <th>State</th>
                                                <td><?php echo $view_summary['register']['state'] ?></td>
                                            </tr>
                                            <?php } ?>
                                            <tr>
                                                <th>Country</th>
                                                <td><?php echo $view_summary['register']['country'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>Type of Work</th>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $view_summary['create_profile']['employment'] ?></td>
                                            </tr>
                                            <tr>
                                                <th>Job Category</th>
                                                <td><?php echo $view_summary['create_profile']['job_category'] ?></td>
                                            </tr>                                           
                                            <?php } } else { ?>
                            ...
                            <div id="create_summary" class="tab-pane fade">
                                <div class='form-group widt_form_under_tab row_use_what_career_dashbored'>
                                    <form method="post">
                                        ...
                                        <input type="hidden" name="form_id" value="<?php echo $view_summary['create_profile']['id'] ?>">
                                        <h1>Career Profile</h1>
                                        <div class='form-group form_edit'>
                                            <div class='form-group form_edit' style="background: #eee;padding: 4% !important;line-height: 22px;font-size: 15px;"> 
                                                <strong>Name</strong><br/>
                                                <input type='text' name="name" readonly="" value="<?php echo ucfirst($view_summary['register']['first_name']). ' '.ucfirst($data['register']['last_name']) ?>"/><br/>
                                                <?php if($view_summary['register']['country'] == 'Canada') { ?>
                                                <strong>Province</strong><br/>
                                                <input type='text' name="province" readonly="" value="<?php echo $view_summary['register']['provence'] ?>"/><br/>
                                                <?php } ?>
                                                <?php if($view_summary['register']['country'] == 'United States') { ?>
                                                <strong>State</strong><br/>
                                                <input type='text' name="state" readonly="" value="<?php echo $view_summary['register']['state'] ?>"/><br/>
                                                <?php } ?>   
                                                <strong>Country</strong><br/>
                                                <input type='text' name="country" readonly="" value="<?php echo $view_summary['register']['country'] ?>"/><br/>
                                                <strong>Type of Work</strong><br/>
                                                <select name="work_type">
                                                    <option value="">--Select Type--</option>
                                                    <option value="Full Time" <?php echo ($view_summary['create_profile']['work_type'] == 'Full Time' ? 'selected="selected"' : '') ?>>Full Time</option>
                                                    <option value="Part Time" <?php echo ($view_summary['create_profile']['work_type'] == 'Part Time' ? 'selected="selected"' : '') ?>>Part Time</option>
                                                </select>
                                                <strong>Employment Group</strong><br/>
                                                <select name="employment">
                                                    <option value="">--Select Type--</option>
                                                    <option value="Student" <?php echo ($view_summary['create_profile']['employment'] == 'Student' ? 'selected="selected"' : '') ?>>Student</option>
                                                    <option value="Veteran" <?php echo ($view_summary['create_profile']['employment'] == 'Veteran' ? 'selected="selected"' : '') ?>>Veteran</option>
                                                    <option value="Apprentice" <?php echo ($view_summary['create_profile']['employment'] == 'Apprentice' ? 'selected="selected"' : '') ?>>Apprentice</option>
                                                    <option value="Job Seeker" <?php echo ($view_summary['create_profile']['employment'] == 'Job Seeker' ? 'selected="selected"' : '') ?>>Job Seeker</option>
                                                    <option value="Career Advance" <?php echo ($view_summary['create_profile']['employment'] == 'Career Advance' ? 'selected="selected"' : '') ?>>Career Advance</option>
                                                </select>
                                                <strong>Job Category</strong><br/>
                                                <input type="text" name="job_category" value="<?php echo $view_summary['create_profile']['job_category'] ?>">
                                                <button type="submit">Save</button>
                                            </div>
                                        </div>
                                        <?php } } else { ?>
                                        ...
                                        <div class='form-group form_edit' style="background: #eee;padding: 4% !important;line-height: 22px;font-size: 15px;">                                            
                                            ...
                                            <strong>Province</strong><br/>
                                            <input type='text' name="province" readonly="" value="<?php echo $data['register']['provence'] ?>"/><br/>
                                                <?php } ?>
                                                <?php if($data['register']['country'] == 'United States') { ?>
                                            <strong>State</strong><br/>
                                            <input type='text' name="state" readonly="" value="<?php echo $data['register']['state'] ?>"/><br/>
                                                <?php } ?>
                                            <strong>Country</strong><br/>
                                            <input type='text' name="country" readonly="" value="<?php echo $data['register']['country'] ?>"/><br/>
                                                <?php } ?>
                                            <strong>Type of Work</strong><br/>
                                            <select name="work_type">
                                                <option value="">--Select Type--</option>
                                            ...
                                            <select name="employment">
                                                ...
                                                <option value="Career Advance">Career Advance</option>
                                            </select>
                                            <strong>Job Category</strong><br/>
