...
<html lang="en">
    <head>
        ...
        <style>
            .new_padding{margin: 1em;border:2px solid #000;}
            .err {
                padding: 15px 15px;
                margin-bottom: 10px;
                color: #a94442;
        ...
        <div class="new_view" style="margin:2% 3% 2% 3%;">	
            <div class="col-lg-12 col-md-12  ">
                ...
                <ul class="nav nav-tabs new_proper">   
                    ...
                    <li class="hide_class" id="work_experience"><a data-toggle="tab" href="#work_exp">Workplace Experience</a></li>
            <!-- <li class="pull-right" style="margin-right: 10px;"><i class="fa fa-thumbs-down liked_icon"></i><span class="number_div"><?php echo $total_dislike[0][0]['count(like_career)']; ?></span></li> -->
                    ...
                    <li class="invite_data"><button class="invite_btn_use" id="invite_id">Create Access</button></li>
                    <li class="invite_data" onclick="readMsg(<?php echo $user_id; ?>)"><a data-toggle="tab" href="#message_send" class="invite_btn_use">Message<?php if($status_data == TRUE) { ?><span class="label label-default label_new_div" style="font-weight: bold !important;">New</span><?php } ?></a></li>
                    ...
                    <li class="pull-right" style="margin-right: 10px;"><i class="fa fa-thumbs-up liked_icon"></i><span class="number_div"><?php echo $total_like[0][0]['count(like_career)']; ?></span></li>
                    <li class="invite_data"><button class="invite_btn_use" id="invite_id">Create Access</button></li>
                    <li class="invite_data"><a data-toggle="tab" href="#invitation_send" class="invite_btn_use">Invitation Sent</a></li>
                    <li class="invite_data" onclick="readMsg(<?php echo $user_id; ?>)"><a data-toggle="tab" href="#message_send" class="invite_btn_use">Message<?php if($status_data == TRUE) { ?><span class="label label-default label_new_div" style="font-weight: bold !important;">New</span><?php } ?></a></li>                   
                    <?php } ?>
                </ul>
            ...
            <?php echo $ref_data['verify_reference']['title'] ?>
                ...
                <?php echo $ref_data['verify_reference']['hr_date'] ?>
                        ...
                        <div class='tab-content tabs_use'>
                            <div id="key_add" class="tab-pane fade active in">
                                ...
                                ?>
                                    ...
                                    <div class="repeat_border_div new_padding">
                                        <div>
                                            <h1 style="background-color: #000; color: #fff;"><input type='checkbox' class="checkbox_key" value="<?php echo $key_skill['key_skill']['id'] ?>">&nbsp;&nbsp;&nbsp;Key Skill

                                            </h1>
                                        </div>
                                        <table class="table_use_div word_div table-responsive bd_table">
                            ...
                            <div id="key_added" class="tab-pane fade">
                                ...
                                ?>
                                    ...
                                    <div class="repeat_border_div" style="margin: 1em; border: 2px solid #000;">
                                        <div>
                                            <h1 style="background-color: #1d1d1d; color: #fff;">Key Skill
                    ...
                    <div id="work_exp" class="tab-pane fade">
                        <ul class="nav nav-tabs new_proper">
                            <li class="active"><a data-toggle="tab" href="#work_exp_add">Add To MyCD</a></li>
                            <li><a data-toggle="tab" href="#work_exp_added">Added To MyCD</a></li>                           
                        </ul>
                        <div class='tab-content tabs_use'>
                            <div id="work_exp_add" class="tab-pane fade active in">
                                <?php if(count($work_exp) > 0) { ?>
                                <div class="key_skill_button_div">
                                    <h2 style="font-size: 15px; padding-top: 15px; padding-left: 15px;">Check the items you want to add then click on the blue button "Add to My CD button"</h2>
                                    <button id="add_work_exp">Add to My CD</button>                                           
                                </div>
                                <?php } ?>
                                <div class='work_div_para_scroll'>
                                <?php if(count($work_exp) > 0) {
                               foreach ($work_exp as $w_place) { ?>
                                    <div class="repeat_border_div">
                                        <div class="brdr" style="margin-bottom:1em;">
                                            <div>
                                                <h1><input type='checkbox' class="checkbox_work_exp" value="<?php echo $w_place['workplace_experience']['id'] ?>">&nbsp;&nbsp;&nbsp;Workplace Experiences
                                                </h1>
                                            </div>
                                            <div class="arund">
                                                <div class='div_margin'>
                            ...
                            <div id="work_exp_added" class="tab-pane fade">
                                <?php if(count($work_exp_added) > 0) {
                                    foreach ($work_exp_added as $w_place) {
                                        
                                ?>
                                <div class="repeat_border_div">
                                    <div>
                                        <h3 style="background: #c02430;color: #fff;margin: 2% 0%;padding-left: 2em;border: solid 2px #c02430;text-transform: uppercase;">Workplace Experiences <button style="margin-right: 2em;" class="essen_skill_div_delete1 pull-right" onclick='delete_mycd("<?php echo $w_place['workplace_experience']['id'] ?>", "workplace_experience")'>Delete</button>
                                        </h3>
                                    </div>
                                    <div class="arund">
                                        <div class='div_margin'>
