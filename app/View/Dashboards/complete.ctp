                ...
                <div class="panel panel-info">
                        ...
                        <div class='row bg_use_div'>
                            <div class="table">
                                <table class="table table-user-information new_progress_use new_table table-responsive">
                                    <thead>
                                        <tr>
                                            <th colspan="6" class="main_heading heading_data_design"><h2>Co-OP Evaluation</h2></th>
                                        </tr>	
                                        <tr>
                                    ...
                                    <tbody>
	                                   ...
	                                   if($data['verify_reference']['reference_name'] == 'coop_verification') {
					    $c++;
				    ?>
                                        <tr>
                                            ...
                                            <td><a href="complete_view.html?id=<?php echo $data['verify_reference']['id'] ?>"><button class="worked_data_used">View</button></a></td>
                                            <td><button class="worked_data_used_new" onclick='delete_reference("<?php echo $data['verify_reference']['id'] ?>")'>Delete</button></td>
                                        </tr>
                                        <?php } } ?>
                                        <?php if ($c == 0) { ?>
				    ...
				    ?>
                                        <tr>
                                            ...
                                            <td><?php echo date('d-M-Y',strtotime($data['verify_reference']['submit_date']))?></td>
                                            <td>
					<?php if($data['verify_reference']['accept'] == '1') {
					echo "Accept";
					} else if($data['verify_reference']['accept'] == '2') {
					echo "Decline";
					}
                                        ?>
                                            </td>
    ...
    <script>
        function delete_reference(id) {
            if (confirm("Are you sure")) {
                $.ajax({
                    url: "<?php echo Router::url(['controller'=>'dashboards/deleteReference']) ?>",
                    type: "POST",
                    data: {'delete_ref': id},
